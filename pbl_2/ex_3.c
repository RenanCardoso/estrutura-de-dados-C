...
/* Escreva um programa que permita combinar dois arrays não ordenados. Cada um dos
 * arrays pode ser colocado em um terceiro array na ordem que você prefere.
 */
...
int main(void){
	...
	printf("\n\nNovo array ordenado do menor valor ao maior\n");
    //utlizei o qtd * 2 pois terei a qtd dos dois arrays para percorrer
	for (i = 0; i < qtd * 2; ++i)
